import style from "./englsih.css";
import { FaTelegramPlane } from "react-icons/fa";
import { FaStar } from "react-icons/fa6";
export default function English() {
  return (
    <div className="level-type">
      <div className="tuwshin">
        <p>Анхан</p>
        <p>Суурьтай анхан</p>
        <p>Анхан дунд</p>
        <p>Дунд шат</p>
      ...
      <div className="trails">
        <div className="cards">
          <div className="grid">
            <div className="grid-item novice">
              <FaTelegramPlane className="star" />
              <h3>30 ХОНОГИЙН АНГЛИ ХЭЛНИЙ ДҮРМИЙН ЭРЧИМЖҮҮЛСЭН ХӨТӨЛБӨР.</h3>
              <li>
                30 ХОНОГИЙН АНГЛИ ХЭЛНИЙ ДҮРМИЙН ЭРЧИМЖҮҮЛСЭН ХӨТӨЛБӨРТӨӨ ЭЛСЭЛТ
                АВЧ ЭХЭЛЛЭЭ.
              </li>
            </div>
            <div className="grid-item intermediate">
              <FaTelegramPlane className="star" />
              <h3>
                30 ХОНОГИЙН АНГЛИ ХЭЛНИЙ ЯРИА, СОНСГОЛ ХОСОЛСОН ХӨТӨЛБӨР.{" "}
              </h3>
              <li>
                30 ХОНОГИЙН АНГЛИ ХЭЛНИЙ ЯРИА, СОНСГОЛ ХОСОЛСОН ХӨТӨЛБӨРТӨӨ
                ЭЛСЭЛТ АВЧ ЭХЭЛЛЭЭ.
              </li>
            </div>
            <div className="grid-item expert">
              <FaTelegramPlane className="star" />
              <h3>IELTS / TOFEL</h3>
              <li>
                IELTS-ийн шалгалтад бэлтгэх сургалт нь тус шалгалтад хэрхэн
                өндөр оноо авах тал дээр техник, стратеги заана.
              </li>
            </div>
          </div>
        </div>
