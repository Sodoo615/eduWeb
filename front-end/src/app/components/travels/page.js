    ...
    <div className="main-travel">
      ...
      <div className="travel">
        <div className="cards">
          ...
          <div className="card">
            <Link href="../../components/travels/aylal2">
          ...
          <div className="card">
            <Link href="../../components/travels/aylal3">
          ...
          <div className="card">
            <Link href="../../components/travels/aylal4">
          ...
          <div className="card">
            <Link href="../../components/travels/aylal5">
              <img src="https://visitmongolia.sgp1.digitaloceanspaces.com/images/4bd736f5-5a70-4af8-b5fd-c56e5bf0f5c3.jpg" />
            </Link>
          ...
          <div className="card">
            <Link href="../../components/travels/aylal6">
